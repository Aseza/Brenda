import { Component, OnInit, Output,EventEmitter, Input, DoCheck, IterableDiffers, SimpleChanges } from '@angular/core';
...
export class SearchComponent implements OnInit {
  ...
  Search(word:string, minIndex:number , maxIndex:number,event:any, isFirstSearch:boolean){
    ...
    this.dataServiceImp.searchAProject(word, minIndex,maxIndex).subscribe(result => {
