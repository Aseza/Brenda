...
public class ProjectDAOImpl implements ProjectDAO {
	...
	public int removeProject(int id) {
		Query query = getCurrentSession().createQuery("delete from Project where id=:ID");
	...
	public int createProject(Project project) {
		Transaction tx1 = getCurrentSession().beginTransaction();
		Serializable result = getCurrentSession().save(project);
		tx1.commit();
	...
	public void updateProject(int id, Project newProject) {
		Transaction tx2 = getCurrentSession().beginTransaction();
